...
# Za regresiju se može koristiti neuronska mreža MLPRegressor. Navedeni su neki od hiperparametara. Ostale možete pronaći u dokumentaciji modela.
...
# r = AdaBoostRegressor().fit(x_train, y_train)
